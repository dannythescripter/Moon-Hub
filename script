...
elseif placeId == 7449423635 then
	...
	game.Players.LocalPlayer:Kick("เธฃเธฑเธเธเธดเธ”เน€เน€เธกเธเธฃเธถเธเนเธฒเธง เนเธญเธซเธเธธเนเธก")
end
...
local Tab1 = Main.create("เน€เธกเธเธนเธซเธฅเธฑเธ")

local Tab2 = Main.create("เธเธนเนเน€เธฅเนเธ/เธชเน€เน€เธ•เธ")

local Tab3 = Main.create("เธงเธฒเธ/เธ”เธฑเธเน€เธเธตเนเธขเธ")

local Tab4 = Main.create("เธฃเนเธฒเธเธเนเธฒ")

local Tab5 = Main.create("เธญเธทเนเธ เน")
...
function AutoFarmLevel()
	...
	if _G.Settings.Main["เธญเธญเนเธ•เนเธเธฒเธฃเนเธกเน€เธฃเนเธง"] and (MyLevel >= 15 and MyLevel <= 300) then
...
function WebHookLog:WebHookKaiTanSend(WebHookUrl)
	...
	local Embeds = {{
		...
		["fields"] = {
			...
			{
				["name"] = "ใ…ค",
				["value"] = tostring("ใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…คใ…ค"),
				["inline"] = false
			}},
		["footer"] = {
